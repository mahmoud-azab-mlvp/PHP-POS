...
<!--Sweet Alert-->
<script src="dashboard/plugins/sweetalert/sweetalert.js"></script>
    ...
    //echo $email . " __ " . $password;
     ...
     if($row ["email"] == $email AND $row["password"] == $password AND $row["role"] == "Admin"){
      ...
      echo '<script type="text/javascript">jQuery(function validation(){
        ...
        //echo '<script> window.open ("myURL","dashboard_admin");</script>';
     ...
     echo '<script type="text/javascript">jQuery(function validation(){
        swal({
            title: "Warring Email Or Password Is Wrong ",
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>PHP</b>POS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="login">Login In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="forget_passowrd.php">I forgot my password</a><br>
